...
class Program
{
    ...
    static void InsertionSort(int[] arr)
    {
        ...
        /* 
         * --- Оцінка методу вставками ---
         * Складність у найгіршому випадку: O(n²)
         * Складність у найкращому випадку: O(n)
         * Середня складність: O(n²)
         * Використання пам’яті: O(1)
         * Алгоритм стабільний (однакові елементи зберігають порядок)
         * 
         * Переваги: проста реалізація, добра ефективність на малих або частково впорядкованих масивах.
         * Недолік: низька продуктивність для великих обсягів даних.
         */
    }
